...
- [x] Configure workspace root `package.json` with `build`, `dev:osd`, `typecheck` scripts
...
- [x] Define commit scope enum: `sense-art`, `demo-osd`, `ci`, `docs`, `deps`, `release`
...
- [x] Create `src/ai/fixtures/artwork-map.json` — hand-crafted 3×3 fixture for MockProvider (dev/CI)
